...
export interface PageSignals {
  /** We're on the people-search results URL. */
  onSearchPage: boolean;
  /** A login / auth wall was detected (redirected or a login form present). */
  loginWall: boolean;
  /** One of the known results-list containers was found in the DOM. */
  hasResultsContainer: boolean;
  /** How many profile URLs the extractor actually pulled from the page. */
  matched: number;
}
 ...
 */
export function diagnoseEmptyPage(s: PageSignals): string {
