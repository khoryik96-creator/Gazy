...
export function initScoreButton(): void {
 ...
 * still going.
 */
export function rehydrateScoringStatus(): void {
  chrome.runtime.sendMessage({ type: MESSAGE.GET_SCORING_STATUS }, (status?: ScoringStatus) => {
