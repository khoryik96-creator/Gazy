...
import { serializeWorkspace, parseWorkspace, keysToClearOnRestore, WORKSPACE_KEYS, } from '../shared/workspaceBackup.js';
...
function queueReload() {
    if (reloadTimer !== null)
        return; // a reload is already pending; it'll pick this up
